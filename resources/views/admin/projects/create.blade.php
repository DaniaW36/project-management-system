                    ...
                    <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('proj_name') is-invalid @enderror" 
                                           id="proj_name" name="proj_name" value="{{ old('proj_name') }}" required>
                                    @error('proj_name')
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('proj_desc') is-invalid @enderror" 
                                      id="proj_desc" name="proj_desc" rows="3" required>{{ old('proj_desc') }}</textarea>
                            @error('proj_desc')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('proj_status') is-invalid @enderror" 
                                        ...
                                        <option value="Pending" {{ old('proj_status') == 'Pending' ? 'selected' : '' }}>Pending</option>
                                        <option value="In Progress" {{ old('proj_status') == 'In Progress' ? 'selected' : '' }}>In Progress</option>
                                        <option value="On Hold" {{ old('proj_status') == 'On Hold' ? 'selected' : '' }}>On Hold</option>
                                        <option value="Completed" {{ old('proj_status') == 'Completed' ? 'selected' : '' }}>Completed</option>
                                    </select>
                                    @error('proj_status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('proj_statusDetails') is-invalid @enderror" 
                                              id="proj_statusDetails" name="proj_statusDetails" rows="1">{{ old('proj_statusDetails') }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('proj_start_date') is-invalid @enderror" 
                                           id="proj_start_date" name="proj_start_date" value="{{ old('proj_start_date') }}" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('proj_end_date') is-invalid @enderror" 
                                           id="proj_end_date" name="proj_end_date" value="{{ old('proj_end_date') }}" required>
                                    @error('proj_end_date')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
